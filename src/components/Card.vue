<template>
  <div
    @click="openModal"
    class="group relative p-4 sm:p-6 rounded-2xl border border-white/70 dark:border-gray-800 bg-white dark:bg-background-dark backdrop-blur-md dark:backdrop-blur-none shadow-lg shadow-accent/10 dark:shadow-none hover:shadow-xl hover:shadow-accent/20 dark:hover:shadow-accent-dark/10 hover:border-accent/40 dark:hover:border-accent-dark/40 hover:bg-white/80 dark:hover:bg-background-dark hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col gap-4 @container cursor-pointer"
  >
